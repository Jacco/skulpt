...
class TimeTestCase(unittest.TestCase):
    ...
    def test_default_values_for_zero(self):
        ...
        # based on its value.
        expected = "2000 01 01 00 00 00 6 001" # Jacco/Skulpt todo: changed 1 to 6 here
        # bug: skulpt does not support tuple mulitplication (0,)*9
    ...
    def _test_tzset(self):
        ...
        # systems.
        eastern = 'EST+05EDT,M4.1.0,M10.5.0'       #America/New_York
        victoria = 'AEST-10AEDT-11,M10.5.0,M3.5.0' #Australia/Melbourne
        utc='UTC+0'                                #UTC
